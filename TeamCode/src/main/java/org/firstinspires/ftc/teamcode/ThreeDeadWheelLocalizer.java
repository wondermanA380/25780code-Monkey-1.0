...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 2432.0854742913825;//2379.192097570285; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -2425.4609625979356;//-2504.627855388533; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1436.9306092837191;//-1427.8522880316664; // x position of the perpendicular encoder (in tick units)
    }
